...
public class QustomDialogBuilder extends AlertDialog.Builder{
    ...
    public QustomDialogBuilder setTitleBold(boolean var) {
        if(var){
            mTitle.setTypeface(null, Typeface.BOLD);
        }
        return this;
    ...
    public QustomDialogBuilder setPositiveButton(boolean var) {
        if(var)
        {
            this.setPositiveButton("Aceptar", new android.content.DialogInterface.OnClickListener() {
                @Override
